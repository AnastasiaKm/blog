...
class AuthorTagsController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('author.tags.index')->with('tags', $tags);
    ...
    public function store(Request $request)
    {
      ...
      return redirect()->route('author.tags.index');
    ...
    public function show($id)
    {
      ...
      return view('author.tags.show')->with('tag', $tag);
    ...
    public function edit($id)
    {
      ...
      return view('author.tags.edit')->with('tag', $tag);
