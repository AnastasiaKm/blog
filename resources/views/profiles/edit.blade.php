	...
	<div class="container">
		<div class="row">
			<div class="col-sm-3">
				...
				src="/images/{{ $user->avatar }}" width="300" height="300">
			</div>
					...
					<div class="panel-body">
						...
						@if ($user->profile)
							@if (Auth::user()->id == $user->id)
								...
								{{-- {!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->name],  'class' => 'form-horizontal', 'role' => 'form', 'files' => true ]) !!} --}}
