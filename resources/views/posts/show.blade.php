...
<div class="row">
  <div class="col-md-6">
    @if(isset($post->photo_id))
      <img src="{{ $photo->file }}" class="img-responsive" style="width:500px; height:300px;">
    @endif
    <h1>{{ $post->title }}</h1>
  ...
  <div class="row">
    <div id="comment-form" class="col-md-5">
      {{ Form::open(['route' => ['comments.store', $post->id, $user->id],
                     'method' => 'POST']) }}
